...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        current_county_votes = county_votes.get(county_name)
        ...
        if (current_county_votes > winning_county_votes) and (county_votes_percentage > winning_county_percentage):
            winning_county_votes = current_county_votes
